            ...
            <div className="container">
                    ...
                    <div className="slider">
                        <ul>
                            ...
                            <li><img className="logo" src="../../assets/images/languages/typescript.png" alt="logo-typescript" /></li>
                            <li><img className="logo" src="../../assets/images/languages/react.png" alt="logo-react" /></li>
                            <li><img className="logo" src="../../assets/images/languages/angular.png" alt="logo-angular" /></li>
                            <li><img className="logo" src="../../assets/images/languages/nodejs.png" alt="logo-nodejs" /></li>
                            <li><img className="logo" src="../../assets/images/languages/express.png" alt="logo-express" /></li>
